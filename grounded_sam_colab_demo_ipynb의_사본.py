...
local_image_path = "assets/ship_b_1_0011371.jpg"
...
annotated_frame, detected_boxes = detect(image, text_prompt="ship", model=groundingdino_model)
...
prompt="hawaii beach, no Lighthouse"
